...
class Analytics(object):
    ...
    def __init__(self, c):
        ...
        self.classavgimprovement = [] #array used to calculate avg student improvement per class
        self.classavgm = []
        self.classavgr = []
        self.classavgw = []
        for username in users:
            ...
            if len(user.tests_taken) != 0:
                ...
                if len(user.tests_taken) > 1:
                    overall_score, writing_score, reading_score, math_score = 0,0,0,0 
                    overall_score, writing_score, reading_score, math_score =  user.score_improvement()
                    #self.classavgimprovement.append([overall_score, user.name])
                    self.classavgw.append([writing_score, user.name])
                    self.classavgr.append([reading_score, user.name])
                    self.classavgm.append([math_score, user.name])
        ...
        #sort class rankings
        self.classavgr.sort(key = lambda score: score[:][0], reverse = False)
        self.classavgw.sort(key = lambda score: score[:][0], reverse = False)
        self.classavgm.sort(key = lambda score: score[:][0], reverse = False)
        ...
        self.math_class_scores.sort(key = lambda score: score[:][0])
        self.reading_class_scores.sort(key = lambda score: score[:][0])
        self.writing_class_scores.sort(key = lambda score: score[:][0])
    ...
    def report(self):
        ...
        lines.append('<title>Class Analytics Report</title>' + endl)
       ...
       #lines.append('<br><table style="width:500px">')
        ...
        length = len(self.math_class_scores)
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Math Scores On Their Most Recent Test</h1>' + endl)
        lines.append('<div id="chart11" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Math Scores'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart11' + "'" + ', [' + endl)
        lines.append(str(self.math_class_scores) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        lines.append('shadowAngle: 135, ' + endl)
        lines.append('rendererOptions: { fillToZero: true,' + endl)
        lines.append('varyBarColor: true,' + endl)
        lines.append('barDirection: ' + "'" + 'horizontal' + "'" + endl)
        lines.append('}' + endl)
        lines.append('},' + endl)
        lines.append('legend: {show:false, renderer: $.jqplot.EnhancedLegendRenderer, ' + endl)
        lines.append('rendererOptions: { ' + endl)
        lines.append('numberRows: 1 ' + endl)
        lines.append('},' + endl)
        lines.append('placement: ' + "'" + 'insideGrid' + "'" + ',' + endl)
        lines.append('labels: label, '+ endl)
        lines.append('location: ' + "'" + 'se' + "'" + '},' + endl)
        lines.append('axes: { ' + endl)
        lines.append('xaxis: { label:' + "'" + 'Points' + "'}," + endl)
        #lines.append('xaxis:{ min:200, max:2400, renderer: $.jqplot.CategoryAxisRenderer,label:' + "'" + 'Test Score' + "'" + '},' + endl)
        lines.append('yaxis: { ' + endl)
        lines.append('renderer: $.jqplot.CategoryAxisRenderer, ' + endl)
        lines.append('label: ' + "'" + 'Class' + "'" + ',' + endl)
        lines.append('labelRenderer: $.jqplot.CanvasAxisLabelRenderer' + endl)
        lines.append('}' + endl)
        lines.append('}' + endl)
        lines.append('});' + endl)
        ...
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Reading Scores On Their Most Recent Test</h1>' + endl)
        lines.append('<div id="chart12" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Reading Scores'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart12' + "'" + ', [' + endl)
        lines.append(str(self.reading_class_scores) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        ...
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Writing Scores On Their Most Recent Recent</h1>' + endl)
        lines.append('<div id="chart13" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Wrting Scores'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart13' + "'" + ', [' + endl)
        lines.append(str(self.writing_class_scores) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        ...
        length = len(self.classavgm)
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Math Score Improvement - Most Recent vs First Test -</h1>' + endl)
        lines.append('<div id="chart8" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Math Score Improvement'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart8' + "'" + ', [' + endl)
        lines.append(str(self.classavgm) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        lines.append('shadowAngle: 135, ' + endl)
        ...
        lines.append('location: ' + "'" + 'se' + "'" + '},' + endl)
        lines.append('axes: { ' + endl)
        lines.append('xaxis: { label:' + "'" + 'Student Point Improvement - Most Recent vs First Test -' + "'}," + endl)
        #lines.append('xaxis:{ min:200, max:2400, renderer: $.jqplot.CategoryAxisRenderer,label:' + "'" + 'Test Score' + "'" + '},' + endl)
        lines.append('yaxis: { ' + endl)
        lines.append('renderer: $.jqplot.CategoryAxisRenderer, ' + endl)
        lines.append('label: ' + "'" + 'Class' + "'" + ',' + endl)
        ...
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Reading Score Improvement - Most Recent vs First Test -</h1>' + endl)
        lines.append('<div id="chart9" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Reading Score Improvement'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart9' + "'" + ', [' + endl)
        lines.append(str(self.classavgr) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        lines.append('shadowAngle: 135, ' + endl)
        ...
        lines.append('<br><hr color="#4169EF" size="1" width="90%">' + endl)
        lines.append('<br><h1>Student Writing Score Improvement - Most Recent vs First Test -</h1>' + endl)
        lines.append('<div id="chart10" style="height:' + str(length*50) +'px; width:500px;"></div>' + endl)
        lines.append('<script class="code" type="text/javascript">' + endl)
        lines.append('$(document).ready(function(){' + endl)
        lines.append('var label = [' + "'" + 'Writing Score Improvement'  + "'" + '];' + endl)
        lines.append('var plot2 = $.jqplot(' + "'" + 'chart10' + "'" + ', [' + endl)
        lines.append(str(self.classavgw) + '], {' +endl)
        lines.append('seriesDefaults: {' + endl)
        lines.append('renderer:$.jqplot.BarRenderer,' + endl)
        lines.append('pointLabels: { show: true, location: ' + "'" + 'e' + "'" + '},' + endl)
        lines.append('shadowAngle: 135, ' + endl)
